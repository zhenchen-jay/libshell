/**
 * Source: https://gitlab.com/libeigen/eigen/-/blob/master/Eigen/src/AccelerateSupport/AccelerateSupport.h
...
using AccelerateLLT = AccelerateImpl<MatrixType, UpLo | Eigen::Symmetric, SparseFactorizationCholesky, true>;
 ...
 */
template <typename MatrixType, int UpLo = Eigen::Lower>
using AccelerateLDLT = AccelerateImpl<MatrixType, UpLo | Eigen::Symmetric, SparseFactorizationLDLT, true>;
 ...
 */
template <typename MatrixType, int UpLo = Eigen::Lower>
using AccelerateLDLTSBK = AccelerateImpl<MatrixType, UpLo | Eigen::Symmetric, SparseFactorizationLDLTSBK, true>;
 ...
 */
template <typename MatrixType, int UpLo = Eigen::Lower>
using AccelerateLDLTTPP = AccelerateImpl<MatrixType, UpLo | Eigen::Symmetric, SparseFactorizationLDLTTPP, true>;
...
template <typename MatrixType_, int UpLo_, SparseFactorization_t Solver_, bool EnforceSquare_>
class AccelerateImpl : public Eigen::SparseSolverBase<AccelerateImpl<MatrixType_, UpLo_, Solver_, EnforceSquare_>> {
protected:
...
private:
    template <typename T>
    void buildAccelSparseMatrix(const Eigen::SparseMatrix<T>& a,
                                AccelSparseMatrix& A,
...
template <typename MatrixType_, int UpLo_, SparseFactorization_t Solver_, bool EnforceSquare_>
template <typename Rhs, typename Dest>
void AccelerateImpl<MatrixType_, UpLo_, Solver_, EnforceSquare_>::_solve_impl(const Eigen::MatrixBase<Rhs>& b,
